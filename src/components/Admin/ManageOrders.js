                ...
                <tr className='text-center' key={Math.random()}>
                    ...
                    <td>
                        <div className='d-flex flex-column'>
                            ...
                            className='mt-2 btn bg-none' style={{color:'red'}}>Is Deliver</button>
                        </div>
                    </td>
                    <td>{item.payment_methods}</td>
                    ...
                    <td>
                        <img className='w2' src={ 
                            item.payment_img === null ? 
                            `https://4.bp.blogspot.com/-7Hxbfa7Le5E/UC4-_-rxhrI/AAAAAAAAB_w/_kO7NHqmb-c/s1600/default+no+image.png` 
                            :`http://localhost:2010/manageorders/${item.payment_img}`} alt="img"></img>
                    </td>
                    <td className='d-flex flex-column'>
                        <button onClick={()=>{this.detailOrders(item.id, item.user_id)}} className='btn btn-success m-2 btn-sm'>Detail Orders</button>
                        ...
                        <button onClick={()=>{this.confirmPayment(item.id)}} className='btn btn-light m-2 btn-sm'>Confirm Payment</button>
                        <button onClick={()=>{this.cancelPayment(item.id)}} className='btn btn-danger m-2 btn-sm'>Cancel Payment</button>
                    </td>
                </tr>
            )
